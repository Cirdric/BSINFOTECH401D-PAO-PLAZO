...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('students.index')->with('success', 'Student Information Added Successfully!');
    }
    ...
    public function destroy(string $id)
    {
        $student = Student::findOrFail($id);
        $student->delete();
        return redirect()->route('students.index')->with('success', 'Students Information Deleted Successfully!');
    }
}
